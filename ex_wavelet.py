...
def ex_wavelet():
    ...
    sol = pp.Optimize.run_IMRT_fluence_map_CVXPy(my_plan, solver='MOSEK', opt_params = {'smoothness_weight': 5})
    sol_low_dim = LowDimRT.run_IMRT_fluence_map_low_dim(my_plan, solver='MOSEK', opt_params = {'smoothness_weight': 5})
